...
const SmartContract: NextPage = () => {
  return (
    <div className="w-full relative bg-whitesmoke-200 overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-24 box-border gap-[73px] leading-[normal] tracking-[normal] mq450:gap-[18px] mq750:gap-[36px]">
      <Depth2Frame5 />
