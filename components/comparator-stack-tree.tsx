...
const ComparatorStackTree: NextPage = () => {
  return (
    <div className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[7px] box-border max-w-full shrink-0 text-left text-base text-black font-work-sans">
      <div className="flex-1 rounded-[5.24px] box-border flex flex-row flex-wrap items-start justify-start py-2 pr-3.5 pl-4 gap-[15.5px] max-w-full border-[1px] border-solid border-gainsboro-700">
          ...
          <div className="flex-1 flex flex-col items-start justify-center min-w-[221px] max-w-full">
            <div className="self-stretch overflow-hidden flex flex-col items-start justify-start">
              <div className="self-stretch flex flex-col items-start justify-start">
                <div className="relative leading-[24px] font-medium inline-block min-w-[92px]">
                  Milestone 2
                </div>
              </div>
            </div>
...
export default ComparatorStackTree;
