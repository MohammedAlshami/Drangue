...
const Depth2Frame1: NextPage = () => {
  return (
    <header className="self-stretch bg-white box-border flex flex-row items-center justify-between py-3 pr-0 pl-10 top-[0] z-[99] sticky max-w-full gap-[0px] [row-gap:20px] text-left text-lg text-gray-500 font-lexend border-b-[1px] border-solid border-gainsboro-100">
      <img
      ...
      <div className="w-[1034.5px] flex flex-row items-start justify-end py-0 pr-[0.1px] pl-0 box-border max-w-full mq450:gap-[16px]">
        <div className="flex flex-row items-start justify-end py-0 px-6 box-border gap-[32px] max-w-full mq450:gap-[16px]">
          <nav className="m-0 w-[305px] flex flex-row items-center justify-start py-[9.5px] px-0 box-border mq450:gap-[18px] mq750:w-[-13.600000000000025px] mq1250:hidden">
