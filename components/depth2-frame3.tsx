...
const Depth2Frame3: NextPage = () => {
  return (
    <header className="self-stretch bg-white flex flex-row items-center justify-between py-[12.5px] pr-0 pl-10 shrink-0 [debug_commit:f6aba90] text-left text-lg text-gray-500 font-lexend border-b-[1px] border-solid border-gainsboro-100">
      <img
